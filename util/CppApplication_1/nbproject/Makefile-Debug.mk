...
${OBJECTDIR}/_ext/5c0/Drawable.o: ../Drawable.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/Drawable.o ../Drawable.cpp

${OBJECTDIR}/_ext/5c0/Matrix.o: ../Matrix.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/Matrix.o ../Matrix.cpp

${OBJECTDIR}/_ext/5c0/Primitives.o: ../Primitives.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/Primitives.o ../Primitives.cpp

${OBJECTDIR}/_ext/5c0/RenderController.o: ../RenderController.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/RenderController.o ../RenderController.cpp

${OBJECTDIR}/_ext/5c0/vector.o: ../vector.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/vector.o ../vector.cpp
